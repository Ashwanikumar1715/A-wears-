    ...
    <>
      ...
      <main className="w-full mt-12 sm:pt-20 sm:mt-0">
        ...
        <div className="flex sm:w-4/6 sm:mt-4 m-auto mb-7 bg-white shadow-lg">
          {/* <!-- sidebar column  --> */}
          <div className="loginSidebar bg-[#ab7de3] p-10 pr-12 hidden sm:flex flex-col gap-4 w-2/5 rounded-lg hover:bg-[#0e11e3]">
            <h1 className="font-medium text-white text-3xl">LOGIN</h1>
            <p className="text-gray-200 text-lg">
              Fill the credentials to access your account!!
            </p>
          </div>
          {/* <!-- sidebar column  --> */}
              ...
              <form onSubmit={handleLogin}>
                <div className="flex flex-col w-full gap-4 ">
                  ...
                  <div className="flex flex-col gap-2.5 mt-2 mb-32">
                    ...
                    <button
                      type="submit"
                      className="text-white py-3 w-full bg-[#660fd1] shadow hover:shadow-lg rounded-lg font-medium"
                    >
                      Login
                    </button>
                    <Link
