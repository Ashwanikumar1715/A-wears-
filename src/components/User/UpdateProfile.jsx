            ...
            >
              <div className="flex flex-col gap-4 items-start">
                ...
                <div className="flex flex-col w-full justify-between sm:flex-row gap-3 items-center">
                  ...
                  />
                  <label className="rounded font-medium bg-[blue] text-center cursor-pointer text-white w-full py-2 px-2.5 shadow hover:shadow-lg">
                    <input
                      type="file"
                      name="avatar"
                      accept="image/*"
                ...
                <button
                  type="submit"
                  className="text-white py-3 w-full bg-[#660fd1] shadow rounded-lg font-medium hover:shadow-lg"
                >
                  Update
                </button>
                <Link
