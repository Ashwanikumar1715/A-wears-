...
const NewProduct = () => {
  ...
  return (
    <>
      <MetaData title="Admin: New Product | A-Wears" />
        ...
        <div className="flex flex-col gap-2 m-2 sm:w-1/2">
          ...
          <div className="flex justify-end">
            <input
              form="mainform"
              type="submit"
              className="bg-primary-green uppercase w-1/3 p-3 text-white font-medium rounded shadow hover:shadow-lg cursor-pointer"
              value="Submit"
            />
          </div>
        </div>
