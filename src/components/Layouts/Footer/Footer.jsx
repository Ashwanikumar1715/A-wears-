...
const Community = ["Popular", "Discounts", "Events"];
...
const Footer = () => {
  ...
  return (
    <>
     {!adminRoute && (
     <>
      <div className="bg-[#0a0a0af6] mx-7 rounded-3xl mb-10  ">
          ...
          <div className="lg:w-[50%] flex flex-wrap flex-row justify-between lg:border-r lg:border-richblack-700 pl-3 lg:pr-5 gap-3">
            <div className="w-[30%] flex flex-col gap-3 lg:w-[30%] mb-7 lg:pl-0">
              ...
              <div className="flex flex-col gap-2">
                {["About", "Contact", "stories"].map((ele, i) => {
                  return (
                    <div
                      key={i}
                      className="text-[gray] cursor-pointer hover:text-[#7b03fc] transition-all duration-200"
                    >
              ...
              <div className="flex flex-col gap-2 mt-2">
                {Resources.map((ele, index) => {
                  return (
                    <div
                      key={index}
                      className="text-[gray] cursor-pointer hover:text-white transition-all duration-200"
                    >
      ...
      {/* bottom footer */}
      <div className="flex flex-row items-center justify-between w-11/12 max-w-maxContent text-[gray] mx-auto pb-14 text-sm">
        {/* Section 1 */}
        <div className="flex justify-between lg:items-start items-center flex-col lg:flex-row gap-3 w-full">
          <div className="flex ">
            {BottomFooter.map((ele, ind) => {
              return (
                <div
                  key={ind}
                  className={` ${BottomFooter.length - 1 === ind ? "" : "border-r border-white "}
          ...
          <div className="text-center flex flex-col sm:flex-row ">
            ...
            <span className="text-[#7b03fc]"> A-Wears </span>
          </div>
