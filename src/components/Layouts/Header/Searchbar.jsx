...
const Searchbar = () => {
    ...
    return (
        ...
        <input value={keyword} onChange={(e) => setKeyword(e.target.value)} className="text-sm w-full flex-1 outline-none border-none placeholder-gray-500" type="text" placeholder="Search farm byproducts" />
